...
const EditProfile = ({BackendServer }) => {
  ...
  const handleProfilePicChange = (e) => {
    ...
    if (!allowedExtensions.includes(fileExtension)) {
      setImageError('Invalid file type. Only .jpg, .jpeg, .png, .gif, and .bmp are allowed.');
      setProfileData(prevData => ({
        ...prevData,
        profilepic: null,
      }));
  ...
  return (
    isLoggedIn ? (
      <div className="container my-5">
        <div className="row">
          ...
          <div className="col-md-4 mb-4">
            {/* Profile Image Card */}
            <div className="card shadow-lg border-light rounded-4 mb-4" style={{ backgroundColor: '#f8f9fa' }}>
              <div className="card-body text-center position-relative">
                <div className="position-relative d-inline-block">
                  <img
                    src={profileData.profilepic ? profileData.profilepic : 'https://via.placeholder.com/150'}
                    alt="User Profile"
                    className="rounded-circle mb-3"
                    style={{ width: '150px', height: '150px', objectFit: 'cover', cursor: 'pointer', border: '4px solid #007bff' }}
                ...
                />
                <h4 className="mt-3 mb-1" style={{ fontWeight: 'bold' }}>{`${profileData.firstname || 'First Name'} ${profileData.lastname || 'Last Name'}`}</h4>
            ...
            <div className="card shadow-lg border-light rounded-4" style={{ backgroundColor: '#f8f9fa' }}>
          ...
          <div className="col-md-8">
            <div className="card shadow-lg border-light rounded-4" style={{ backgroundColor: '#f8f9fa' }}>
              <div className="card-header bg-primary text-white text-center" style={{ borderTopLeftRadius: '0.375rem', borderTopRightRadius: '0.375rem' }}>
                <h3>Edit Profile</h3>
              ...
              <div className="card-body p-4">
                <form onSubmit={handleSubmit}>
                  ...
                  <button type="submit" className="btn btn-primary w-100" style={{ borderRadius: '25px' }}>
                    Save Changes
                  </button>
                </form>
              </div>
      ...
      <div>Unauthorized Access. Please <a href="/login">log in</a>.</div>
    )
  );
};
